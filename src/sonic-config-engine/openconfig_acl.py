...
class yc_config_openconfig_acl__acl_acl_sets_acl_set_acl_entries_acl_entry_dynamic_acl_config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-acl - based on the path /acl/acl-sets/acl-set/acl-entries/acl-entry/dynamic-acl/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_path_helper', '_extmethods', '__ttl',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__ttl = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="ttl", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='https://github.com/Azure/sonic-buildimage', defining_module='sonic-acl-extension', yang_type='uint32', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'acl', u'acl-sets', u'acl-set', u'acl-entries', u'acl-entry', u'dynamic-acl', u'config']

  def _get_ttl(self):
    """
    Getter method for ttl, mapped from YANG variable /acl/acl_sets/acl_set/acl_entries/acl_entry/dynamic_acl/config/ttl (uint32)

    YANG Description: TTL(in second).
    """
    return self.__ttl
      
  def _set_ttl(self, v, load=False):
    """
    Setter method for ttl, mapped from YANG variable /acl/acl_sets/acl_set/acl_entries/acl_entry/dynamic_acl/config/ttl (uint32)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="ttl", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='https://github.com/Azure/sonic-buildimage', defining_module='sonic-acl-extension', yang_type='uint32', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """ttl must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="ttl", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='https://github.com/Azure/sonic-buildimage', defining_module='sonic-acl-extension', yang_type='uint32', is_config=True)""",
        })
  ...
  _pyangbind_elements = OrderedDict([('ttl', ttl), ])


class yc_dynamic_acl_openconfig_acl__acl_acl_sets_acl_set_acl_entries_acl_entry_dynamic_acl(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-acl - based on the path /acl/acl-sets/acl-set/acl-entries/acl-entry/dynamic-acl. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_path_helper', '_extmethods', '__config',)

  _yang_name = 'dynamic-acl'
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__config = YANGDynClass(base=yc_config_openconfig_acl__acl_acl_sets_acl_set_acl_entries_acl_entry_dynamic_acl_config, is_container='container', yang_name="config", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='https://github.com/Azure/sonic-buildimage', defining_module='sonic-acl-extension', yang_type='container', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'acl', u'acl-sets', u'acl-set', u'acl-entries', u'acl-entry', u'dynamic-acl']

  def _get_config(self):
    """
    Getter method for config, mapped from YANG variable /acl/acl_sets/acl_set/acl_entries/acl_entry/dynamic_acl/config (container)
    """
    return self.__config
      
  def _set_config(self, v, load=False):
    """
    Setter method for config, mapped from YANG variable /acl/acl_sets/acl_set/acl_entries/acl_entry/dynamic_acl/config (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_config is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_config() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=yc_config_openconfig_acl__acl_acl_sets_acl_set_acl_entries_acl_entry_dynamic_acl_config, is_container='container', yang_name="config", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='https://github.com/Azure/sonic-buildimage', defining_module='sonic-acl-extension', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """config must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=yc_config_openconfig_acl__acl_acl_sets_acl_set_acl_entries_acl_entry_dynamic_acl_config, is_container='container', yang_name="config", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='https://github.com/Azure/sonic-buildimage', defining_module='sonic-acl-extension', yang_type='container', is_config=True)""",
        })
...
class yc_acl_entry_openconfig_acl__acl_acl_sets_acl_set_acl_entries_acl_entry(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__sequence_id','__config','__state','__l2','__ip','__transport','__input_interface','__actions','__icmp','__dynamic_acl',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__dynamic_acl = YANGDynClass(base=yc_dynamic_acl_openconfig_acl__acl_acl_sets_acl_set_acl_entries_acl_entry_dynamic_acl, is_container='container', yang_name="dynamic-acl", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='https://github.com/Azure/sonic-buildimage', defining_module='sonic-acl-extension', yang_type='container', is_config=True)
...
with an entry
  ...
  def _get_dynamic_acl(self):
    """
    Getter method for dynamic_acl, mapped from YANG variable /acl/acl_sets/acl_set/acl_entries/acl_entry/dynamic_acl (container)
    """
    return self.__dynamic_acl
      
  def _set_dynamic_acl(self, v, load=False):
    """
    Setter method for dynamic_acl, mapped from YANG variable /acl/acl_sets/acl_set/acl_entries/acl_entry/dynamic_acl (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_dynamic_acl is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_dynamic_acl() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=yc_dynamic_acl_openconfig_acl__acl_acl_sets_acl_set_acl_entries_acl_entry_dynamic_acl, is_container='container', yang_name="dynamic-acl", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='https://github.com/Azure/sonic-buildimage', defining_module='sonic-acl-extension', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """dynamic_acl must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=yc_dynamic_acl_openconfig_acl__acl_acl_sets_acl_set_acl_entries_acl_entry_dynamic_acl, is_container='container', yang_name="dynamic-acl", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='https://github.com/Azure/sonic-buildimage', defining_module='sonic-acl-extension', yang_type='container', is_config=True)""",
        })

    self.__dynamic_acl = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_dynamic_acl(self):
    self.__dynamic_acl = YANGDynClass(base=yc_dynamic_acl_openconfig_acl__acl_acl_sets_acl_set_acl_entries_acl_entry_dynamic_acl, is_container='container', yang_name="dynamic-acl", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='https://github.com/Azure/sonic-buildimage', defining_module='sonic-acl-extension', yang_type='container', is_config=True)
  ...
  dynamic_acl = __builtin__.property(_get_dynamic_acl, _set_dynamic_acl)


  _pyangbind_elements = OrderedDict([('sequence_id', sequence_id), ('config', config), ('state', state), ('l2', l2), ('ip', ip), ('transport', transport), ('input_interface', input_interface), ('actions', actions), ('icmp', icmp), ('dynamic_acl', dynamic_acl), ])
